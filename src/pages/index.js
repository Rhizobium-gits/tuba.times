...
<div style={{ textAlign: 'center', margin: '30px 0' }}>
      ...
      <div style={{ textAlign: 'center', marginBottom: '30px' }}>
        <p style={{ lineHeight: '1.8' }}>
          ...
          東京科学大学（旧東京医科歯科大学) 難治疾患研究所 計算システム生物学分野 (PI: 島村徹平)<br />
          ADvance Lab 副所長
        </p>
      </div>
      ...
      <p style={{ lineHeight: '1.8', marginBottom: '15px' }}>
       ...
       <a href="https://www.youtube.com/@RyuichiSakamotoArchive" style={{ color: '#0000EE' }} target="_blank" rel="noopener noreferrer">坂本龍一</a>，<a href="https://www.youtube.com/channel/UCeMhZbWtGvULvXgEspzzfKA" style={{ color: '#0000EE' }} target="_blank" rel="noopener noreferrer">Goldmund</a>，<a href="https://www.youtube.com/@sakanactionchannel" style={{ color: '#0000EE' }} target="_blank" rel="noopener noreferrer">サカナクション</a>，<a href="https://www.youtube.com/@ZUTOMAYO" style={{ color: '#0000EE' }} target="_blank" rel="noopener noreferrer">ZTMY</a>をよく聞きます．ジャズも聞きます．
...
<li><a href="/tsubafont" style={{ color: '#0000EE' }}>Tsubaふぉんと について</a>         
 <img 
        ...
        - <a href="/furniture" style={{ color: '#0000EE' }}>お気に入りのガジェット</a> - <a href="/seasons" style={{ color: '#0000EE' }}>季節の景色</a> - <a href="/music" style={{ color: '#0000EE' }}>音楽</a> - <a href="https://www.youtube.com/watch?v=W8RCRGdCC7I" style={{ color: '#0000EE' }} target="_blank" rel="noopener noreferrer">なんか頑張ってる動画</a> - <a href="/zatta" style={{ color: '#0000EE' }}>雑多な記録</a> - 
